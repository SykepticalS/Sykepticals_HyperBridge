package com.d4viddf.hyperbridge.xposed.mediacard.notification.layout

import android.content.Context
import android.view.View
import com.d4viddf.hyperbridge.xposed.mediacard.MediaCardConstants
import com.d4viddf.hyperbridge.xposed.mediacard.notification.layout.coloros.NotificationMediaColorOsLayout
import com.d4viddf.hyperbridge.xposed.mediacard.notification.layout.ios.NotificationMediaIosLayoutPreset
import com.d4viddf.hyperbridge.xposed.mediacard.notification.layout.miui.NotificationMediaMiuiLayout
import com.d4viddf.hyperbridge.xposed.mediacard.notification.layout.oneui.NotificationMediaOneUiLayout
import com.d4viddf.hyperbridge.xposed.mediacard.notification.layout.pixel.NotificationMediaPixelLayout
...
internal object NotificationMediaLayoutController {
    fun apply(
        ...
        val coverHidden = coverStyle == MediaCardConstants.NOTIFICATION_MEDIA_COVER_STYLE_HIDDEN
        ...
        if (coverHidden) {
            ...
            if (layoutStyle == MediaCardConstants.NOTIFICATION_MEDIA_LAYOUT_STYLE_SYSTEM) {
                bridge.setGoneMargin(
                    normalLayout,
                    ids.actions,
        ...
        if (layoutStyle != MediaCardConstants.NOTIFICATION_MEDIA_LAYOUT_STYLE_PIXEL) {
            applyActionOverrides(
                ...
                keepAction4 = layoutStyle == MediaCardConstants.NOTIFICATION_MEDIA_LAYOUT_STYLE_COLOROS &&
                        !hideDevice,
        ...
        if (hideTime && layoutStyle != MediaCardConstants.NOTIFICATION_MEDIA_LAYOUT_STYLE_PIXEL) {
    ...
    private fun applyActionOverrides(
        ...
        val ordered = when (actionsOrder) {
            MediaCardConstants.NOTIFICATION_MEDIA_ACTION_ORDER_CUSTOM_RIGHT ->
