...
import com.d4viddf.hyperbridge.xposed.mediacard.notification.NotificationMediaHostApi
import com.d4viddf.hyperbridge.xposed.mediacard.notification.NotificationMediaHostClasses
import com.d4viddf.hyperbridge.xposed.mediacard.progress.view.SpringInterpolator
...
internal class NotificationMediaMultiCardRenderer(
    ...
    fun prepareNativeEdgeGesture(side: EdgeActionSide): Boolean {
        ...
        MediaCardLog.d(TAG, "多卡片边缘手势已交给 SystemUI 原生媒体滑动菜单: $side")
        return true
    }
    ...
    private fun warn(message: String, error: Throwable? = null) {
        MediaCardLog.w(TAG, message, error)
    }
}
