package com.sykeptical.hyperbridge.ui.navigation
...
import com.sykeptical.hyperbridge.ui.screens.home.HomeScreen
import com.sykeptical.hyperbridge.ui.screens.onboarding.OnboardingScreen
import com.sykeptical.hyperbridge.ui.screens.settings.AppPriorityScreen
import com.sykeptical.hyperbridge.ui.screens.settings.BackupSettingsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.BlocklistAppListScreen
import com.sykeptical.hyperbridge.ui.screens.settings.ChangelogHistoryScreen
import com.sykeptical.hyperbridge.ui.screens.settings.EngineSettingsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.DiagnosticsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.FloatingNotificationSetupScreen
import com.sykeptical.hyperbridge.ui.screens.settings.GlobalBlocklistScreen
import com.sykeptical.hyperbridge.ui.screens.settings.GlobalSettingsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.ImportPreviewScreen
import com.sykeptical.hyperbridge.ui.screens.settings.InfoScreen
import com.sykeptical.hyperbridge.ui.screens.settings.IslandSettingsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.LicensesScreen
import com.sykeptical.hyperbridge.ui.screens.settings.NavCustomizationScreen
import com.sykeptical.hyperbridge.ui.screens.settings.PrioritySettingsScreen
import com.sykeptical.hyperbridge.ui.screens.settings.SetupHealthScreen
import com.sykeptical.hyperbridge.util.BackupManager
...
fun mainNavGraph(
    ...
    entry<Screen.DndSettings> {
        com.sykeptical.hyperbridge.ui.screens.settings.DndSettingsScreen(onBack = { navigator.goBack() })
    }
    entry<Screen.PermanentIslandConfig> {
        com.sykeptical.hyperbridge.ui.screens.settings.PermanentIslandConfigScreen(onBack = { navigator.goBack() })
    }
    entry<Screen.ReplyCustomization> {
        com.sykeptical.hyperbridge.ui.screens.theme.GlobalReplyCustomizationScreen(onBack = { navigator.goBack() })
    }
