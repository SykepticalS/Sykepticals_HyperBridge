...
import com.sykeptical.hyperbridge.util.parseBold
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsSection(
                ...
                items = buildList {
                    add(SettingsItemData(Icons.Default.SettingsSuggest, stringResource(R.string.system_setup), stringResource(R.string.system_setup_subtitle), onSetupClick))
                    add(SettingsItemData(Icons.Default.SettingsSuggest, stringResource(R.string.floating_setup_title), stringResource(R.string.floating_setup_settings_subtitle), onFloatingSetupClick))
                    if (BuildConfig.DEBUG) {
                        add(SettingsItemData(Icons.Default.Code, stringResource(R.string.diagnostics_title), stringResource(R.string.diagnostics_subtitle), onDiagnosticsClick))
                    }
                    add(SettingsItemData(Icons.Default.Tune, stringResource(R.string.island_behavior), stringResource(R.string.limit_strategy), onBehaviorClick))
                    add(SettingsItemData(Icons.Default.Palette, stringResource(R.string.global_settings), stringResource(R.string.island_appearance), onGlobalSettingsClick))
                    add(SettingsItemData(Icons.Default.Block, stringResource(R.string.blocked_terms), stringResource(R.string.spoiler_subtitle), onBlocklistClick))
                    add(SettingsItemData(Icons.Default.Save, stringResource(R.string.backup_restore_title), stringResource(R.string.backup_section_title), onBackupClick))
                }
            )
            ...
            SettingsSection(
                ...
                items = listOf(
                    ...
                    SettingsItemData(Icons.Default.Person, stringResource(R.string.developer), stringResource(R.string.developer_subtitle)) { uriHandler.openUri("https://github.com/SykepticalS") },
                    SettingsItemData(Icons.Default.History, stringResource(R.string.version_history), "0.1.0 - $appVersion", onHistoryClick),
                    SettingsItemData(Icons.Default.Code, stringResource(R.string.source_code), stringResource(R.string.source_code_subtitle)) { uriHandler.openUri("https://github.com/SykepticalS/HyperBridge-master") },
