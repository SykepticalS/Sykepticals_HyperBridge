...
import com.sykeptical.hyperbridge.ui.screens.theme.CreatorOptionCard
import com.sykeptical.hyperbridge.ui.screens.theme.CreatorRoute
import com.sykeptical.hyperbridge.ui.screens.theme.ShapeStyle
import com.sykeptical.hyperbridge.ui.screens.theme.getExpressiveShape
...
fun NotificationTypesContent() {
    ...
    val enabledCallStages by preferences.globalCallStagesFlow.collectAsState(
        initial = CallStage.entries.toSet()
    )
